...
description: >
  ...
  companion file from ticket.md, spec.md, plan.md, or shipped.md and opens
  it in the developer's browser. Always invoked with explicit dev consent —
  markdown remains the source of truth; HTML is a derived, opt-in view
  designed for stage-appropriate comprehension.
tier: workflow
alwaysApply: false
---
...
> `ticket.md`, `spec.md`, `plan.md`, `shipped.md`."
